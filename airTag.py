...
class AirTag:
    ...
    def __init__(self, ctx, jsonFile=None, jsonString=None):
        self.log = ctx.log
        self.cfg = ctx.cfg
    ...
    @id.setter
    def id(self, value):
        self._needsSave = self._needsSave or (value != self.__id)
        self.__id = value
    ...
    def toDict(self):
        return {'name': self._name,
                'privateKey': "" if self._privateKey is None else base64.b64encode(self._privateKey).decode('ascii'),
                'advertisementKey': "" if self._advertisementKey is None else base64.b64encode(self._advertisementKey).decode('ascii'),
    ...
    def fromJSON(self, jsonString):
        ...
        self.name = jsn['name']
        self.advertisementKey = jsn['advertisementKey']
        self.id = jsn['id']
